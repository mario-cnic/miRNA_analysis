...
sorted_significant_results <- significant_results[order(significant_results$log2FoldChange),] 
...
pheatmap(heatmap_matrix, cluster_cols = FALSE)

heatmap(heatmap_matrix, scale = "column")
